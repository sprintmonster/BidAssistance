		...
		<div className="space-y-6">
			...
			<div className="bg-white rounded-lg border border-gray-200 p-8">
				<div className="mb-4">
					{isEditing ? (
						...
						<span
							className={`px-3 py-1 rounded text-sm font-medium ${categoryColors[post.category]}`}
						>
			...
			<div className="bg-white rounded-lg border border-gray-200 p-8">
				<div className="flex items-center gap-2 mb-6">
					...
					<h2 className="text-xl font-bold text-gray-900">댓글 {commentCount}</h2>
				</div>
				...
				<div className="space-y-6">
					{comments.map((comment: any) => {
						const commentAuthorName = comment.authorName ?? comment.author ?? "—";
						const commentAuthorId = comment.authorId as string | undefined;

						const canDeleteThisComment =
							!!canInteract &&
							(!!canEdit ||
								(!!commentAuthorId && !!currentUserId && commentAuthorId === currentUserId) ||
